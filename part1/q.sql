...
INSERT INTO WalkRequests (dog_id, requested_time, duration_minutes, location, status) VALUES
    ...
    ((SELECT dog_id FROM Dogs WHERE name = 'Wi'), '2025-06-12 14:00:00', 45, 'Independence St', 'open'),
    ((SELECT dog_id FROM Dogs WHERE name = 'Bo'), '2025-06-10 09:30:00', 45, '', 'accepted'),
